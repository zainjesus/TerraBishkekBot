...
async def start(message: Message):
    ...
    await bot.send_photo(message.from_user.id, image, caption='Привет! Добро пожаловать в чат-бот бизнес-клуба *Терра Бишкек.*\n\n'
                         'У нас сообщество сильных предпринимателей, объединённых идеей достичь всеобщего благополучия. Все продукты и мероприятия клуба безоплатные..\n\n'
                         'Здесь тебя ждёт:\n\n'
                         '*❤️‍🔥Запуск наставничества от TERRA🤩*\n'
                         '_Сильные предприниматели будут на протяжении 2-ух месяцев помогать участникам достичь целей, увеличить показатели бизнеса, или запустить бизнес._\n\n'
                         'А также много других направлений на безоплатной основе:\n\n'
